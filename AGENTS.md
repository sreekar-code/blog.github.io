...
├── styles.css              # Global styles (current: v=33)
...
- Analytics script (Umami) must be in `<head>`:
  ...
  ```
- CSS link must include cache-busting version: `<link rel="stylesheet" href="styles.css?v=33">`
- Blog posts in `blog/` use `../styles.css?v=33`
