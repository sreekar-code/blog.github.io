...
├── styles.css              # Global styles (current: v=44)
...
- Analytics script (Umami) must be in `<head>`:
  ...
  ```
- CSS link must include cache-busting version: `<link rel="stylesheet" href="styles.css?v=44">`
- Blog posts in `blog/` use `../styles.css?v=44` and `../nav.js?v=3`
