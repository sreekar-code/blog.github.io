...
- **Theme:** "Cool mist" — `bg: #eaecf0`, `text: #20242c`. Soft, light, airy. Not dark.
- **Font:** EB Garamond, loaded via `@import` at the top of `styles.css`. Do not change the font without updating the import.
- Mobile styles use `@media (max-width: 600px)`, desktop overrides use `@media (min-width: 600px)`
